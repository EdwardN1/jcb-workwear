...
function sizing_guide_custom_post() {
	// creating (registering) the custom type 
	register_post_type( 'sizing_guide', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
	 	// let's now add all the options for this post type
		array('labels' => array(
			'name' => __('Sizing Guides', 'jointswp'), /* This is the Title of the Group */
			'singular_name' => __('Sizing Guide', 'jointswp'), /* This is the individual type */
			'all_items' => __('All Sizing Guides', 'jointswp'), /* the all items menu item */
			'add_new' => __('Add New', 'jointswp'), /* The add new menu item */
			'add_new_item' => __('Add New Sizing Guide', 'jointswp'), /* Add New Display Title */
			'edit' => __( 'Edit', 'jointswp' ), /* Edit Dialog */
			'edit_item' => __('Edit Sizing Guides', 'jointswp'), /* Edit Display Title */
			'new_item' => __('New Sizing Guide', 'jointswp'), /* New Display Title */
			'view_item' => __('View Sizing Guide', 'jointswp'), /* View Display Title */
			'search_items' => __('Search Sizing Guides', 'jointswp'), /* Search Custom Type Title */
			'not_found' =>  __('Nothing found in the Database.', 'jointswp'), /* This displays if there are no entries yet */ 
			'not_found_in_trash' => __('Nothing found in Trash', 'jointswp'), /* This displays if there is nothing in the trash */
			'parent_item_colon' => ''
			), /* end of arrays */
			'description' => __( 'Sizing Guides for Products', 'jointswp' ), /* Custom Type Description */
			'public' => true,
			...
			'rewrite'	=> array( 'slug' => 'sizing_guide', 'with_front' => false ), /* you can specify its url slug */
			'has_archive' => 'sizing_guide', /* you can rename the slug here */
	...
	//register_taxonomy_for_object_type('category', 'sizing_guide');
	/* this adds your post tags to your custom post type */
	//register_taxonomy_for_object_type('post_tag', 'sizing_guide');
	
} 

	// adding the function to the Wordpress init
	add_action( 'init', 'sizing_guide_custom_post');
